...
$emailTo='contact@mycdrhelp.com';
  ...
  $nameFrom=$_REQUEST ['name'];
	...
	$eng_detail = $_REQUEST ['eng_detail'];
...
$header = "From: contact@mycdrhelp.com" . "\r\n" . "Reply-To: contact@mycdrhelp.com" . "\r\n" . "Content-type:text/html;charset=iso-8859-1" . "\r\n" . "X-Mailer: PHP/" . phpversion ();
		...
		<td style='border-bottom:2px solid #eee;border-top:2px solid #eee;border-left:2px solid #eee;border-right:2px solid #eee; padding:5px; color:#343333; font-size:13px;' align='left'>" . '&nbsp;' . $country . PHP_EOL . "</td> </tr>";
		
		$message .= "<tr>
		<td style='border-bottom:2px solid #eee;border-top:2px solid #eee;border-left:2px solid #eee; padding:5px; color:#343333; font-size:13px;' align='left'>Engineering Discipline</td>
		<td style='border-bottom:2px solid #eee;border-top:2px solid #eee;border-left:2px solid #eee;border-right:2px solid #eee; padding:5px; color:#343333; font-size:13px;' align='left'>" . '&nbsp;' . $eng_detail . PHP_EOL . "</td> </tr>";
...
$mail->AddAddress($emailTo, $nameTo);
  ...
  $mail->Subject = 'Get Free Consultation Enquiry';
