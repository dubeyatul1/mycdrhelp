...
<ul class="rigt_menu">
 ...
 <li><a href="<?php echo $baseUrl;?>RPEng-report-help"> RPEng Australia <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
...
<li>Direct Conversation with The RPEng Experts
<li>Pay only 75% Advance and 25% after Positive Assessment
<li>Beat the value offer
<li>Complete RPEng Before the Agreed Due Date
 </ol>
</div>
...
<div class="right_part">
<img src="<?php echo $baseUrl;?>images/Secure-Payment.png" alt="Payment Secure by MyCDRHelp" class="img-responsive"> 
 <p>&nbsp;</p>
</div>
 ...
 <div class="home-page-right-sect">
      <h2>Our Top Engineering Experts</h2>
       <div class="home-profile-header">
		...
		<source type="image/webp" srcset="<?php echo $baseUrl;?>img/img1.webp" class="img-responsive">
		<source type="image/jpeg" srcset="<?php echo $baseUrl;?>img/img1.png" class="img-responsive">
		<img src="<?php echo $baseUrl;?>img/img1.png" alt="#" class="img-responsive">
	</picture> </div>
            </div>
        ...
        <div class="home-profile-header">
          <div class="row">
            <div class="col-md-3 col-xs-3">
              <div class="home-profile-image"> <picture>
		<source type="image/webp" srcset="<?php echo $baseUrl;?>img/img2.webp" class="img-responsive">
		<source type="image/jpeg" srcset="<?php echo $baseUrl;?>img/img2.png" class="img-responsive">
		<img src="<?php echo $baseUrl;?>img/img2.png" alt="#" class="img-responsive">
	</picture> </div>
            </div>
            <div class="col-md-9 col-xs-9">
        ...
        <div class="home-profile-header">
          <div class="row">
            <div class="col-md-3 col-xs-3">
              <div class="home-profile-image"> <picture>
		<source type="image/webp" srcset="<?php echo $baseUrl;?>img/img3.webp" class="img-responsive">
		<source type="image/jpeg" srcset="<?php echo $baseUrl;?>img/img3.png" class="img-responsive">
		<img src="<?php echo $baseUrl;?>img/img3.png" alt="#" class="img-responsive">
	</picture> </div>
            </div>
            <div class="col-md-9 col-xs-9">
              <div class="home-profile-content"><h4>Amelia </h4>
        ...
        <div class="home-profile-header">
          <div class="row">
            <div class="col-md-3 col-xs-3">
              <div class="home-profile-image"><picture>
		<source type="image/webp" srcset="<?php echo $baseUrl;?>img/img4.webp" class="img-responsive">
		<source type="image/jpeg" srcset="<?php echo $baseUrl;?>img/img4.png" class="img-responsive">
		<img src="<?php echo $baseUrl;?>img/img4.png" alt="#" class="img-responsive">
	</picture></div>
            </div>
            <div class="col-md-9 col-xs-9">
        ...
        <div class="home-profile-header">
          <div class="row">
            <div class="col-md-3 col-xs-3">
              <div class="home-profile-image"> <picture>
		<source type="image/webp" srcset="<?php echo $baseUrl;?>img/img5.webp" class="img-responsive">
		<source type="image/jpeg" srcset="<?php echo $baseUrl;?>img/img5.png" class="img-responsive">
		<img src="<?php echo $baseUrl;?>img/img5.png" alt="#" class="img-responsive">
	</picture> </div>
            </div>
            <div class="col-md-9 col-xs-9">
...
<a href="<?php echo $baseUrl;?>order-now"><picture>
  <source type="image/webp" srcset="<?php echo $baseUrl;?>images/Privacy-security.webp" class="img-responsive">
  <source type="image/jpeg" srcset="<?php echo $baseUrl;?>images/Privacy-security.png" class="img-responsive">
  <img src="<?php echo $baseUrl;?>images/Privacy-security.png" alt="RPEng Report Writing Help" class="img-responsive">
</picture> </a>
...
<picture>
  <source type="image/webp" srcset="<?php echo $baseUrl;?>images/MyCDRHelp-how-it-works.webp" class="img-responsive">
  <source type="image/jpeg" srcset="<?php echo $baseUrl;?>images/MyCDRHelp-how-it-works.png" class="img-responsive">
  <img src="<?php echo $baseUrl;?>images/MyCDRHelp-how-it-works.png" alt="CDR Writing Help" class="img-responsive">
</picture>
</div>   
