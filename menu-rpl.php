...
<h3>Quick Links</h3>
<ul class="rigt_menu">
 <li><a href="<?php echo $baseUrl;?>"> Home <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
 <li><a href="<?php echo $baseUrl;?>about">  About Us  <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
 <li><a href="<?php echo $baseUrl;?>rpl-writing-services"> RPL Help <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
 <li><a href="<?php echo $baseUrl;?>rpl-review-services">RPL Review Services <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
 <li><a href="<?php echo $baseUrl;?>RPL-sample"> RPL Sample <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
 <li><a href="<?php echo $baseUrl;?>contact"> Contact Us <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
 <li><a href="<?php echo $baseUrl;?>order-now"> Order Now <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
</ul>
</div>
...
<li>ACS Assessed Engineers as RPL Writers
<li>10+ Years of Experience
<li>Australia Based Company
<li>All Engineering Disciplines
<li>100% Success Rate with ACS
<li>100% Plagiarism Free RPL Report/Turnitin
...
<li>Direct Conversation with The RPL Experts
<li>Pay only 75% Advance and 25% after Positive Assessment
<li>Beat the value offer
<li>Complete RPL Before the Agreed Due Date
</ol>
</div>
